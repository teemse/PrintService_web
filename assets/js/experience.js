...
const exp = [
  {
    ...
    desp: "<li>Наша команда состоит из опытных специалистов, которые прошли специализированное обучение и обладают глубокими знаниями в области заправки картриджей и ремонта оргтехники. Мы постоянно следим за последними тенденциями в отрасли, чтобы быть в курсе всех новых технологий и методов обслуживания.</li>",
  },
  {
